...
UAs = []
UAs.append(
    "Mozilla/5.0 (Windows; U; WinNT; de; rv:1.0.2) Gecko/20030311 Beonex/0.8.2-stable")
UAs.append(
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.6; rv:9.0) Gecko/20100101 Firefox/9.0")
UAs.append(
    "Mozilla/5.0 (X11; Linux x86_64; rv:5.0) Gecko/20100101 Firefox/5.0 Firefox/5.0")
UAs.append(
    "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6;de-De; rv:1.9.2.9) Gecko/20100824 Firefox/3.6.9")
...
UAs.append(
    "Opera/9.80 (Windows NT 6.1; U; de-DE) Presto/2.9.181 Version/12.00")
UAs.append(
    ...
    def _handleError(self, function, tries, msg="Unspecified"):
        for trial in xrange(tries):
            try:
                ...
                exception = e
                self._sleep()
                logger.info("Caught exception, try %s/%s. Action was: %s" %
                            (trial, tries, msg))
                logger.exception(e)
